...
this.T_STATIC=true;
return escape('<table width=\'240\'><tr><td class=\'c\' colspan=\'2\'>Ksi�yc <?php echo $this->getData('luna_name')?> [<?php echo $this->getData('g')?>:<?php echo $this->getData('s')?>:<?php echo $this->getData('i')?>]</td></tr><tr><th width=\'80\'><img src=\'<?php echo $this->getData('dpath')?>planeten/small/s_<?php echo $this->getData('image')?>.jpg\' height=\'75\' width=\'75\'/></th><th style=\'text-align: left\'><a href=\'#\' onclick=\'doit(6, <?php echo $this->getData('g')?>, <?php echo $this->getData('s')?>, <?php echo $this->getData('p')?>, 1, 1)\'>Espiar</a><br /><br /><a href=\'fleet.php?g=<?php echo $this->getData('g')?>&s=<?php echo $this->getData('s')?>&p=<?php echo $this->getData('p')?>&t=1&m=1\'>Atacar</a><br /><a href=\'fleet.php?g=<?php echo $this->getData('g')?>&s=<?php echo $this->getData('s')?>&p=<?php echo $this->getData('p')?>&t=1&m=3\'>Transportar</a></th></tr></table>');">
